...
- (types) [tharsis#503](https://github.com/cosmos/ethermint/pull/503) The `types.DenomDefault` constant for `"nlgton"` has been renamed to `types.AttoPhoton`.
...
- (types) [tharsis#434](https://github.com/cosmos/ethermint/issues/434) Update default denomination to Atto Photon (`nlgton`).
...
- (types) [tharsis#507](https://github.com/cosmos/ethermint/pull/507) Fix hardcoded `nlgton` on `EthAccount` balance getter and setter.
