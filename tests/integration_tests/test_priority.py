...
def test_native_tx_priority(ethermint):
    ...
    test_cases = [
        {
            ...
            "amount": "1000nlgton",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}nlgton",
        ...
        },
        {
            ...
            "amount": "1000nlgton",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}nlgton",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("nlgton"))
