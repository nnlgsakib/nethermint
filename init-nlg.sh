...
KEYRING_BACKEND="os"
TOKEN_DENOM="nlgton"
INITIAL_BALANCE="51000000000000000000000000${TOKEN_DENOM}" # 1 billion tokens for the genesis account
SELF_DELEGATION="10000000000000000000000${TOKEN_DENOM}"    # 1 million tokens for self-delegation
